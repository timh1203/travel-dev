...
const AboutPage = () => (
  <Wrapper modifiers={['pb1R']}>
    ...
    <br />
    <br />
      At the end of the day, we usually act in accordance with our estemeed values. Some important ones for me are time, location-freedom, health, and experiences. There's not one thing I can say that can change your values instantaneously, but instead I will live by example. The very things we do every day define who we are and I believe that discipline will ultimately set you free. Perhaps one day, you'll have an experience that shatters your reality. Until then, it's important not to forget about our dreams through fastidious, daily effort.
    <br />
    <br />
