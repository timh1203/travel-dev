...
const ResourcesCamera = () => (
  <SectionA id="camera">
    ...
    <DivB>
      <ResourcesEntry
        href="https://www.amazon.com/GoPro-CHDHX-502-HERO5-Black/dp/B01M14ATO0/ref=sr_1_3?s=electronics&ie=UTF8&qid=1527001969&sr=1-3&keywords=gopro+5+camera"
        src="https://i.imgur.com/2NFjYsr.png"
        alt="Go Pro Hero 5 Black"
        text={
          <P>
      ...
      />
      <ResourcesEntry
        href="https://www.amazon.com/gp/product/B00GTZJA7Y/ref=oh_aui_detailpage_o08_s00?ie=UTF8&psc=1"
        src="https://i.imgur.com/7tyMhGR.png"
        alt="Joby Gorilla Pod"
        text={
          <P>
      ...
      />
      <ResourcesEntry
        href="https://www.amazon.com/gp/product/B004M8SSZK/ref=oh_aui_detailpage_o09_s00?ie=UTF8&psc=1"
        src="https://i.imgur.com/olTahT5.jpg"
        alt="Joby Gorilla Pod"
        text={
          <P>
      ...
      />
      <ResourcesEntry
        href="https://www.amazon.com/gp/product/B01HU3Q6S4/ref=oh_aui_detailpage_o03_s00?ie=UTF8&psc=1"
        src="https://i.imgur.com/abWoX28.png"
        alt="SanDisk Extreme 64GB microSDXC Card"
        text={
          <P>
      ...
      />
      <ResourcesEntry
        href="https://www.amazon.com/gp/product/B002HJ9PTO/ref=oh_aui_detailpage_o08_s01?ie=UTF8&psc=1"
        src="https://i.imgur.com/amT5LDK.png"
        alt="Audio-Technica ATR-3350 Lavalier Microphone"
        text={
          <P>
