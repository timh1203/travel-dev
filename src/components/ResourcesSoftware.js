...
const ResourcesSoftware = () => (
  <SectionA id="software">
      ...
      <Div>
        <Div>
          <A href="https://namecheap.pxf.io/c/1244000/386170/5618" target="_blank">
            <ImgA src="https://i.imgur.com/VHlW4oG.png" alt="Namecheap Domain Registration" />
          </A>
        </Div>
        <Div>
          <P>
      ...
      <Div>
        <Div>
          <A href="http://www.bluehost.com/track/timothyhoang/" target="_blank">
            <ImgA src="https://i.imgur.com/iBfHVDZ.png" alt="Bluehost Web Hosting" />
          </A>
        </Div>
        <Div>
          <P>
      ...
      <Div>
        <Div>
          <A href="http://www.elegantthemes.com/affiliates/idevaffiliate.php?id=48068&tid1=traveldev" target="_blank">
            <ImgA src="https://i.imgur.com/3OZAEvD.png" alt="Divi Themes by Elegant Themes" />
          </A>
        </Div>
        <Div>
          <P>
    ...
    <Div>
      ...
      <P>
        ♦️ <A href="#" target="_blank">Cloud Player</A> is a audio cloud player that is paired perfectly with Google Drive, Dropbox, or OneDrive. No longer do you have to import your songs to your phone via a cable, just use this service over Wi-Fi instead. Use this to sync all your mp3's, audiobooks, and audio medias. Expect it to take at least an hour and more if you have a larger music collection. It's a one time purchase for $7.99 on Google Play store.
      </P>
      <P>
